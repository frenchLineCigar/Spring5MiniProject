	...
	<div class="card shadow">
		<div class="card-body">
			...
			<div class="d-none d-md-block">
				<ul class="pagination justify-content-center">
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item">
								<a href="${root }board/main?board_info_idx=${board_info_idx}&page=1" class="page-link">처음</a>
							</li>
							<li class="page-item">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<li class="page-item">
								<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageBean.pageCnt}" class="page-link">마지막</a>
							</li>
			...
			<div class="d-block d-md-none">
				<ul class="pagination justify-content-center">
					<li class="page-item">
						<a href="#" class="page-link">이전2222</a>
					</li>
					<li class="page-item">
						<a href="#" class="page-link">다음2222</a>
					</li>
				</ul>
			</div>
